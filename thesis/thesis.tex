...
% to as stylized facts, which are detailed in \S\ref{sec:StylizedFacts}
% and constitute a standardized test suit for model verification.
...
% \S\ref{sec:FundamentalConcepts} presents a few very important
% concepts and notations that will often be referred to in later
% chapters; \S\ref{sec:StylizedFacts} gives a review of the ``stylized
% facts'', i.e. a number of consistently reported and generally accepted
% phenomena that must be accounted for by a returns' model.
