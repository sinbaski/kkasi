...
\end{eqnarray*}
Figure \ref{fig:3point-TW} illustrates the density function of the largest
eigenvalue from a simulated 3-point sample compared with that of the
Tracy-Widom.
\begin{figure}[htb!]
  \centering
  % \subfigure[Normal]{
  ...
  % }
  \subfigure[3-point: $\P(X=sqrt(3)) = \P(X=-sqrt(3)) = 1/6$, $\P(X=0)=2/3$]{
    \includegraphics[scale=0.3]{3point-TW.pdf}
  }
