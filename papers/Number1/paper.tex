...
\begin{eqnarray*}
  ...
  \right]^{-1}
\end{eqnarray*}
When $X_{i1}, X_{i2}, \dots, X_{in}$ are iid for each $i$, the
argument to the $\log$ function is asymptotically uniformly
distributed as $n \to \infty$, and hence $R_{it}$ is a standard
Fr\'echet r.v.
...
\begin{figure}[htb!]
  ...
  is the expected value of the ratio, the red line is the 5\% quantile
  and the green line is the 95\% quantile.}
...
\end{eqnarray*}
The expected values and confident intervals marked in figure
