...
% \input{Mikosch_correlated_sequences}

% \section{Empirical Studies}
% \begin{figure}[htb!]
%   \centering
%   \includegraphics[clip=true, trim=95 258 107 204]{/tmp/SP500-Tails.pdf}
%   \caption{Tail Indices of S\&P 500 stock returns}
%   \label{fig:SP500-Tails}
% \end{figure}
