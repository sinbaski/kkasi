...
Moreover, (ii) and the assumptions (I) and (II) allow the application of
...
Lemma 4.4.2 of Buraczewski et al \cite{buraczewski:damek:mikosch:2016}
conditions (I) and (ii) imply that there exists $\xi > 0$ such that
\[
\lambda(\xi) =
\lim_{n \to \infty}
\left(\E \| A_n \cdots A_1\|^\xi\right)^{1/n}
= 1
\]
