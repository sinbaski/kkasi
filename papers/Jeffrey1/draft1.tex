...
\begin{aug}
% \author{\fnms{Jeffrey} \snm{Collamore}\thanksref{t1,t2,m1}\ead[label=e1]{collamore@math.ku.dk}},
% \author{\fnms{Anand} \snm{Vidyashankar}\thanksref{t3,m1,m2}\ead[label=e2]{avidyash@gmu.edu}}
% \and
% \author{\fnms{Xiaolei} \snm{Xie}\thanksref{t1,m2}
\author{\fnms{Jeffrey} \snm{Collamore}\thanksref{m1}\ead[label=e1]{collamore@math.ku.dk}},
\author{\fnms{Anand} \snm{Vidyashankar}\thanksref{m2}\ead[label=e2]{avidyash@gmu.edu}}
\and
\author{\fnms{Xiaolei} \snm{Xie}\thanksref{m1}
\ead[label=e3]{xie@math.ku.dk}
...
\affiliation{Copenhagen University\thanksmark{m1} and George Mason University\thanksmark{m2}}
