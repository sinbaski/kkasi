...
\begin{remark}
  \label{remark:1}
  From Lemma \ref{lemma:1}, it follows for each $\varphi$
  that satisfies $\E \|A\|^\varphi < \infty$ and
  $\Theta(\varphi) \neq \emptyset$,
...
\begin{theorem}
  If $-\xi$ satisfies the assumption of Remark \ref{remark:1}, and in
  addition $b_{-\xi} \lambda(-\xi) < 1$, then the estimator
  $\mathcal E_u$ has bounded relative error, i.e.
  \begin{equation*}
...
\begin{proof}\setcounter{case}{0}
  ...
  \end{equation}
  \begin{case}
    $-\xi$ satisfies the assumption of Remark \ref{remark:1} and
    $\lambda(-\xi) b_{-\xi} < 1$
  \end{case}
  ...
  \begin{eqnarray*}
    ...
    \sum_{i=0}^{n} \|\Pi_{n, i+1}\| |B| \\
  %% \end{eqnarray*}
  %% Multiplying both sides with $\1{K_1 > n}$
  %% \begin{eqnarray*}  
    \|\Pi_{n, 1}\|^{-1} \1{K_1 > n}
    &\leq& |V_n|^{-1} \1{K_1 > n}
    \left(
    ...
    \right)
  \end{eqnarray*}
  Since $A_i$ are non-negative matrices, we have, for a unit vector $x$,
  \[
