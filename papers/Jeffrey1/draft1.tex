...
\begin{equation}
  ...
  V_t = A_t V_{t-1} + B_t
\end{equation}
with $V_t$, $A_t$ and $B_t$ defined as above. Bollerslev
\cite{bollerslev:1986} showed that the
...
\end{equation}
In the
rest of this paper, we always assume condition \eqref{eq:bollerslev}
is satisfied. For convenience of narration, let $\pi$ denote the
unique stationary distribution of $V_n$ and let $V \sim \pi$.
