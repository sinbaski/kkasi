...
\end{enumerate}
There is yet another useful property of the iid matrices $A_n$. By
Collamore and Mentemeier \cite{collamore:mentemeier:2016},
\eqref{eq:jui} means there is a right eigenfunction $r_\xi(\cdot)$ and
a left eigen-measure associated with the eigenvalue $\lambda(\xi)$ for
the operator $\mathscr P$:
