...
\begin{equation}
  ...
  V_t = A_t V_{t-1} + B
\end{equation}
with $V_t$, $A_t$ and $B_t$ defined as above. Since $A_1, A_2, \dots$
are iid, let $A \overset{d}{=} A_1$ and $Z \overset{d}{=} Z_1$.
...
\xi_n &=& S_n - S_{n-1} = \ln |A_n X_{n-1}|
\end{eqnarray*}
Clearly $(X_n, S_n)$ is a Markov additive process.
