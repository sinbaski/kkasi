...
data from 4th Jan. 2010 to 31st Dec. 2014.
\par
...
\begin{figure}[htb!]
  ...
  \end{minipage}
  \caption{\small Hill estimates $\hat \alpha_{50}$ of the lower tail
    indices $\alpha$ of daily return series in sectors of the S\&P 500
    index. The data span from 4th Jan. 2010 to 31st Dec. 2014 and
    comprise $n=1304$ observations. The graphs from top to bottom
    correspond to the ``Energy'', ``Consumer Staples'' and
...
stronger in ``Energy''. As discussed in section \ref{sec:pareto_tail},
moving along
...
test statistic $\sqrt k (\hat \alpha_X - \hat \alpha_Y)
\overset{d}{\to} N(0, \alpha_X^2 + \alpha_Y^2)$.
