...
\]
So $U(x)$ and hence \eqref{eq:frg} is not monotonic.
...
\]
  ...
  \item If $\min\{1, \xi\} < a < \max\{1, \xi\}$, $y_\pm$ are not
    ...
    \item If in addition $\xi > 1$, i.e. $1 < a < \xi$, $(f - g)(y)$
      ...
      \item If $ \lim_{y \to e^q}f(x) \ge \lim_{y \downarrow e^q} g(y)$,
        ...
        \]
        So $U'(x)$ and hence $U(x)$ as a whole is not monotonic on
        $(0, \infty)$.
  ...
  \item If $a < \min\{1, \xi\}$ and $\xi < 1$, i.e. $a < \xi < 1$, it
    ...
    \item $a > \max\{1, \xi\}$ and $\xi > 1$, i.e. $1 < \xi < a$. By
      ...
      $(f-g)(y) = 0$ on $(1, \infty)$; if $(f-g)(y_+) < 0$,
      there must be a solution to $(f-g)(y) = 0$ on $(y_+, \infty)$.
