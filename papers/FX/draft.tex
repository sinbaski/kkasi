...
\title{Generalized Disappointment Aversion and heavy-tail property of
...
%% We consider investors with preferences that accord with Generalized
...
%% \cite{cochrane2009asset}. This implies investors are more repelled
%% by large losses than they are tempted by large gains. 
%% Furthermore, it is a stylized fact that equity return distributions
%% are heavy-tailed (see e.g. Jansen and de Vries
%% \cite{jansen1991frequency}).
...
sections: In section \ref{sec:empirical_results} we present a survey
of statistical characteristics of equity returns. Then 
...
principles (axiomatic). In this section we infer characteristics of
equity returns from the GDA theory and compare them with the empirical
results.
