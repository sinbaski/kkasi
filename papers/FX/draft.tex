...
\end{eqnarray*}
where $L_+(x)$ and $L_-(x)$ are slowly varying functions satisfying
\[
...
Thus
\[
x^{-\alpha} L_-(x) = J_-(0) x^{-\alpha} + J'_-(0) x^{-\alpha - 1} + O(x^{-\alpha-2})
\]
...
\begin{figure}[htb!]
  ...
  \caption{\small Maximum likelihood estimates of $K$, the scale
    ...
    are the
    estimated values; the bars are the upper bound of the 98\%
