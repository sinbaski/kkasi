...
$\forall x \in (x_0, \infty), {\pd f \over \pd \alpha}(x, \alpha) <
0$. Thus it remains to verify
...
\begin{eqnarray*}
  ...
  < \infty
\end{eqnarray*}
So we conclude $\int_0^\infty {\pd f \over \pd \alpha}(x, \alpha) dx <
\infty$, and by lemma \ref{lemma:I}, $\wt u_{\text{max}}$ is monotonically
