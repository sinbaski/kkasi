...
We also acknowledge that the test is designed to detect a sudden big
change and cannot detect changes that are small but accumulate over
time. This is due to the fact that $T_n$ is not invariant under
permutation of the observations ($X_t$).
If the observations are iid, the null hypothesis is of 
...
accumulated change between two time points to exceed the
