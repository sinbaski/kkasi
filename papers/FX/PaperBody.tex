...
\section{Power-law tails of return series: some empirical results}\label{sec:1}
% \setcounter{equation}{0}
...
dependent \seq s and de Haan and Ferreira \cite{dehaan:ferreira:2006} provide
...
(cf. de Haan and Ferreira~\cite{dehaan:ferreira:2006}, Theorem 2.2.1), one can show
\beao
...
\newpage
\section{Some theoretical arguments for equality of tail-indices}
\label{sec:2}
% \setcounter{equation}{0}
...
\begin{proof}
  ...
  \begin{eqnarray*}
    ...
    = {\partial \over \partial \alpha}\E[u((1 - \phi) e^r + \phi e^x) \1{X < 0}]
  \end{eqnarray*}
