...
\begin{frame}
 ...
 \begin{frame}
   ...
   Also by LLN,
   \begin{eqnarray*}
     \P(\sigma_t^2 > u) &=& {1 \over n} \sum_{t=0}^n \1{\sigma_t^2 > u} \\
     &=& {1 \over n} \left[
...
\begin{frame}
  ...
  +
  {1 \over n}\sum_{t=K_{\mathcal R_n}}^{n} \1{\sigma_t^2 > u}
  \]
...
\begin{frame}
  ...
  \begin{scriptsize}
    ...
    \item Define
      \begin{eqnarray*}
        M_t &=& A_{t} \cdots A_1 \vec V_0 \over |A_{t} \cdots A_1 \vec V_0| \\
        ...
        \xi_t &=& S_t - S_{t-1} =
                  ...
                  \right|
      \end{eqnarray*}
      $(M_t, S_t)$ is a Markov Additive process.
    \end{itemize}
  \end{scriptsize}
\end{frame}
