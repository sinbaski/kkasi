...
{\color{headings}\fontspec[Variant = 2]{Century Schoolbook L} Curriculum {Vit\fontspec[Variant = 3]{Century Schoolbook L}\ae}\\[15pt]\par} % Curriculum vitae text in the Century Schoolbook L font
